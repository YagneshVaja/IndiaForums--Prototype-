...
function makeStyles(c: ThemeColors) {
  return StyleSheet.create({
    ...
    statusOngoing: { backgroundColor: c.primarySoft },
    statusComplete: { backgroundColor: c.successSoft },
    statusText: { fontSize: 9, fontWeight: '700' },
    statusTextOngoing: { color: c.primary },
    statusTextComplete: { color: c.success },
    title: {
      fontSize: 13,
      fontWeight: '800',
      color: c.text,
