export const STORIES = [
  { id: 1, label: 'Celebrities', emoji: '⭐', bg: 'linear-gradient(135deg,#FFF7ED,#FED7AA)', hasStory: true },
  { id: 2, label: 'Videos',      emoji: '🎬', bg: 'linear-gradient(135deg,#EFF6FF,#BFDBFE)', hasStory: true },
